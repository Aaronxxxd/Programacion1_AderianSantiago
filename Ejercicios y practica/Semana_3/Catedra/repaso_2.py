...
# Realizar un programa que registre las notas de varios usuarios. 
# La cantidad de alumnos se va a definir por el usuario
# Cada alumno tendra cargadas 3 notas
# Por cada alumno se necesita el promedio 
# Al final del programa necesitamos promedio general del curso
...
print(f"El alumno con el promedio mayor es el numero {alumno_mayor} con un promedio de {promedio_mayor}")